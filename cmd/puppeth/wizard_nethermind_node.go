...
func (w *wizard) deployNethermindNode(sealer bool) {
	...
	infos, err := checkNode(client, w.network, false)
	if err != nil {
	...
	if out, err := deployNethermindNode(client, w.network, w.conf.bootnodes, infos, nocache); err != nil {
